...
//!
//! Parses sctools:// URLs into DeepLinkImportRequest structures.
...
/// Parse a sctools:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// sctools://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "sctools" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'sctools', got '{scheme}'"
        )));
    }
