...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/sc-tools/blob/main/docs/release-note-v3.6.0-zh.md)**
...
- Download `SC-Tools-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `SC-Tools-v3.6.0-Windows.msi`
- **Portable**: `SC-Tools-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `SC-Tools-v3.6.0-Linux.AppImage`
- **Debian**: `SC-Tools-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/farion1231/sc-tools/compare/v3.5.1...v3.6.0
