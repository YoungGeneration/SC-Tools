...
SC-Tools v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/farion1231/sc-tools/releases/latest) から入手:

- **Windows**: `SC-Tools-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `SC-Tools-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `SC-Tools-v3.8.0-Linux.AppImage` または `.deb`
...
[登録時に「sc-tools」で 10% オフ](https://www.packyapi.com/register?aff=sc-tools)
...
- **Issue**: [GitHub Issues](https://github.com/farion1231/sc-tools/issues)
