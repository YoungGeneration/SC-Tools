...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/sc-tools/blob/main/docs/release-note-v3.6.1-zh.md)**
...
- Download `SC-Tools-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `SC-Tools-v3.6.1-Windows.msi`
- **Portable**: `SC-Tools-v3.6.1-Windows-Portable.zip`
...
- [中文文档 (Chinese)](https://github.com/farion1231/sc-tools/blob/main/README_ZH.md)
- [English Documentation](https://github.com/farion1231/sc-tools/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/farion1231/sc-tools/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/farion1231/sc-tools/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize SC-Tools's configuration storage directory
...
SC-Tools is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/farion1231/sc-tools
