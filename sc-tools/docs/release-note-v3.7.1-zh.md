...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S sc-tools-bin`
...
访问 [Releases](https://github.com/farion1231/sc-tools/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/farion1231/sc-tools/releases/latest) 下载：

- **Windows**：`SC-Tools-Windows.msi` 或 `-Portable.zip`
- **macOS**：`SC-Tools-macOS.tar.gz` 或 `.zip`
- **Linux**：`SC-Tools-Linux.AppImage` 或 `.deb`
...
[使用 "sc-tools" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=sc-tools)
...
- **问题反馈**：[GitHub Issues](https://github.com/farion1231/sc-tools/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/sc-tools/discussions)
